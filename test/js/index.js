...
const num = document.getElementById('in')
    ...
    */
const form = [document.getElementById('dif'), document.getElementById('diffs'), document.getElementById('add'), document.getElementById('sub'), document.getElementById('multi'), document.getElementById('div'), document.getElementById('powers')]
...
function setq(diff) {
    ...
    stuff[1] = Math.floor(Math.random() * numop);
    if (op != [false, false, false, false, false]) {
        while (op[stuff[1]] !== true && count < 1000) {
            stuff[1] = Math.floor(Math.random() * numop);
            count++
            console.log(count)
        }
    ...
    q[2].innerHTML = stuff[2]
        // if operation is 0 = +     1 = -          2 = *    3 = /    4  = powers
    if (stuff[1] == 0) {
